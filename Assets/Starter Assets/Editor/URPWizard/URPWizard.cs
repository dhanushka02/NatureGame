...
{
    // This project uses the Built-in Render Pipeline. Do not let the imported
    // Starter Assets package silently restore URP after asset imports/reloads.
    static readonly bool AutoAssignPipeline = false;

    [InitializeOnLoadMethod]
    static void OnInitialize()
    {
        if (!AutoAssignPipeline)
            return;
